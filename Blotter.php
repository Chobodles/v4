...
<html>
    <head>
        <title>Blotter | Barangay Tugtug E-System</title>
        <link rel="stylesheet" href="cssfile/Blotter.css"/>
        <meta charset="UTF-8"/>
    ...
    <body>
        ...
        <nav class="upbar-container">
            <h1 class="home-title">Blotter Requests</h1>
        </nav>
        ...
        <section class="progress-container">
            ...
            <div class="processing">
                <label class="processing-word">Scheduled</label>
            </div>
            <div class="pending">
                <label class="pending-word">Pending</label>
            </div>
            <div class="ready">
                <label class="ready-word">Resolved</label>
            </div>
        </section>
            ...
            <div class="container-bar">
                <div class="search-wrapper">
                    ...
                    <div class="filter-group">
                        ...
                        <button class="btn-new" onclick="sessionStorage.setItem('from_admin','blotter'); window.location.href='blotterdemo.html'">+ New Request</button>
